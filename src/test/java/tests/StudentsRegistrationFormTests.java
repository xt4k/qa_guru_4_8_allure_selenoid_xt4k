...
public class StudentsRegistrationFormTests extends BaseTest {
    ...
    @Tag("negative")
    @Severity(BLOCKER)
    @DisplayName("Test 03: Check unsuccess Student form registration for not filled required field `First Name`.")
    ...
    @Tag("negative")
    @Severity(BLOCKER)
    @DisplayName("Test 04: Check unsuccess Student form registration for not filled required field `Last Name`.")
